...
const content = ressourcenContent.cta;

const TITLE_PHRASES = content.title.split(". ").map((p) =>
  p.endsWith(".") ? p : p + "."
);

export function RessourcenCta() {
  ...
  return (
    <section
      ...
      aria-labelledby="ressourcen-cta-heading"
    >
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        ...
        <ScrollReveal direction="fade" delay={600}>
          <p className="mt-8 flex items-center justify-center gap-2 text-xs font-light text-foreground/65">
            ...
            Werktags von 09:00 bis 17:00 Uhr erreichbar. Kein Ticket. Kein Umweg.
          </p>
        </ScrollReveal>
      </div>
    </section>
