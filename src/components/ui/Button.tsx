...
const shared =
  "relative overflow-hidden rounded-md border border-black/50 px-3 py-1.5 text-xs sm:px-3.5 sm:py-2 sm:text-sm md:px-4 md:py-2 md:text-sm lg:px-5 lg:py-2.5 lg:text-base font-medium tracking-[0.4px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] inline-flex items-center justify-center transition-all duration-300 active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent";
