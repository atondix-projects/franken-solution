...
```yaml
# .Codex/error-solutions/[error-signature].yaml
...
2. Search `.Codex/error-solutions/` for matching patterns
...
Explain the problem out loud (or to Codex):
